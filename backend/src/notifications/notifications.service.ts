...
const NOTIFICATION_TYPE_TO_PREFERENCE: Record<string, string> = {
  ...
  contribution_pending: 'contributionReminders',
  ...
  loan_repayment_recorded: 'loanUpdates',
  loan_completed: 'loanUpdates',
  loan_overdue: 'loanUpdates',
  expense_pending: 'memberUpdates',
  expense_approved: 'memberUpdates',
  expense_rejected: 'memberUpdates',
